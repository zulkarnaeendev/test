        ...
        <section className="col-span-8 p-24 bg-linear-to-tr from-transparent via-[#252525] to-transparent">
          <div className="max-w-xl">
            <h2 className="text-gray-400 text-[38px] leading-[1.1] mb-16 font-light">
              ...
              jump on <span className="text-[#a54c3a] underline decoration-1 underline-offset-12">conversation</span> chat <br />
              with me.
            </h2>
            <div className="flex ">
              <div className="mt-24 space-y-4">
                ...
                <p className="text-[10px] leading-relaxed opacity-40 max-w-70">
                  I recommend filling out a brief to assess the cost of the project. <a href="#" className="text-[#a54c3a] underline ml-1">Brief</a>
                </p>
              </div>
              <form className="space-y-14">
                ...
                <button className="h-14 w-28 bg-[#a54c3a] rounded-full flex items-center justify-center hover:scale-105 transition-transform duration-300">
